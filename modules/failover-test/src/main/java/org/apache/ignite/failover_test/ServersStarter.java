 ...
 * - Program arguments: --cfg modules/failover-test/config/rcg-server.xml --logCfg ignored --minTtl 60000 --maxTtl 120000 --duration 11520000
 */
public final class ServersStarter {
    ...
    private static IgniteConfiguration getConfiguration(String springCfgPath, @Nullable String logCfgPath)
        ...
        File path = resolveIgnitePath(springCfgPath);
